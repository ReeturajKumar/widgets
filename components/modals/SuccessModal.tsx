...
/**
 * Recreated modern success confirmation modal matching the inspiration design:
 * - Floating concentric green ripple checkmark badge at top
 * - Sleek dark card with warm ambient glow
 * - Full-width rounded orange pill action button
 */
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Floating Top Badge with Concentric Green Ripple Rings */}
        <div className="absolute -top-11 left-1/2 flex -translate-x-1/2 items-center justify-center pointer-events-none select-none">
          {/* Outermost soft green ring */}
          <div className="absolute h-26 w-26 rounded-full bg-emerald-500/10 blur-[1px]" />
          {/* Middle translucent ripple ring */}
          <div className="absolute h-21 w-21 rounded-full bg-emerald-500/20" />
          {/* Inner vibrant green check badge */}
          <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-[#3cd070] shadow-lg shadow-emerald-500/35">
            <svg
              viewBox="0 0 24 24"
